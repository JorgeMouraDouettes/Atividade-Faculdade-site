(() => {
    ...
    var t, e = Object.defineProperty,
       ...
       o = class {
          constructor() {
             r(this, "_strategy"), this._strategy = "function" == typeof requestAnimationFrame ? new n : new a
          }
          requestAnimationFrame(t) {
       ...
       u = "0.24.0",
       l = (t = typeof document < "u" ? document.currentScript?.src : void 0, function (e = {}) {
          var r, n, a = e,
             o = new Promise(((t, e) => {
                r = t, n = e
             })),
             ...
             s = "./this.program",
             u = "";
          typeof document < "u" && document.currentScript && (u = document.currentScript.src), t && (u = t), u = u.startsWith("blob:") ? "" : u.substr(0, u.replace(/[?#].*/, "").lastIndexOf("/") + 1);
          var l, c = a.print || console.log.bind(console),
             d = a.printErr || console.error.bind(console);
          Object.assign(a, i), i = null, a.arguments && a.arguments, a.thisProgram && (s = a.thisProgram), a.quit && a.quit, a.wasmBinary && (l = a.wasmBinary);
          var h, m, p, f, y, g, v, _, w, C = !1;
 
          function $() {
             var t = h.buffer;
             a.HEAP8 = m = new Int8Array(t), a.HEAP16 = f = new Int16Array(t), a.HEAPU8 = p = new Uint8Array(t), a.HEAPU16 = y = new Uint16Array(t), a.HEAP32 = g = new Int32Array(t), a.HEAPU32 = v = new Uint32Array(t), a.HEAPF32 = _ = new Float32Array(t), a.HEAPF64 = w = new Float64Array(t)
          }
          var b = [],
             F = [],
             L = [],
          ...
          function A(t) {
             a.onAbort?.(t), d(t = "Aborted(" + t + ")"), C = !0, t += ". Build with -sASSERTIONS for more info.";
          ...
          E(M = "DotLottiePlayer.wasm") || (S = M, M = a.locateFile ? a.locateFile(S, u) : u + S);
          var D = t => {
             ...
             O = (t, e, r) => {
                ...
                for (var o = ""; e < a;) {
                   ...
                   if (128 & i) {
                      ...
                      if (192 != (224 & i)) {
                         var u = 63 & t[e++];
                         if ((i = 224 == (240 & i) ? (15 & i) << 12 | s << 6 | u : (7 & i) << 18 | s << 12 | u << 6 | 63 & t[e++]) < 65536) o += String.fromCharCode(i);
                         else {
                            var l = i - 65536;
          ...
          var q = t => we(t),
             ...
             z = (t, e, r, n) => {
                ...
                for (var a = r, o = r + n - 1, i = 0; i < t.length; ++i) {
                   ...
                   if (s >= 55296 && s <= 57343 && (s = 65536 + ((1023 & s) << 10) | 1023 & t.charCodeAt(++i)), s <= 127) {
                      if (r >= o) break;
                      e[r++] = s
                   } else if (s <= 2047) {
                      if (r + 1 >= o) break;
          ...
          var G, J, X, Z = {},
             ...
             et = (t, e, r) => {
                ...
                var a = new Array(e.length),
                   ...
                   i = 0;
                e.forEach(((t, e) => {
                   K.hasOwnProperty(t) ? a[e] = K[t] : (o.push(t), Z.hasOwnProperty(t) || (Z[t] = []), Z[t].push((() => {
          ...
          function at(t, e, r = {}) {
             ...
             return function (t, e, r = {}) {
                var n = e.name;
                if (t || nt(`type "${n}" must have a positive integer typeid pointer`), K.hasOwnProperty(t)) {
          ...
          var ot, it = t => ({
             ...
             ft = {},
             yt = (t, e) => ((!e.ptrType || !e.ptr) && tt("makeClassHandle requires ptr and ptrType"), !!e.smartPtrType != !!e.smartPtr && tt("Both smartPtrType and smartPtr must be specified"), e.count = {
                value: 1
             }, gt(Object.create(t, {
                $$: {
                   value: e,
             ...
             gt = t => typeof FinalizationRegistry > "u" ? (gt = t => t, t) : (ut = new FinalizationRegistry((t => {
                ct(t.$$)
             })), lt = t => ut.unregister(t), (gt = t => {
                var e = t.$$;
                if (e.smartPtr) {
                   var r = {
                      $$: e
          ...
          var _t = (t, e) => Object.defineProperty(e, "name", {
             ...
             wt = (t, e, r) => {
                if (void 0 === t[e].overloadTable) {
                   var n = t[e];
                   t[e] = function (...n) {
                      return t[e].overloadTable.hasOwnProperty(n.length) || nt(`Function '${r}' called with an invalid number of arguments (${n.length}) - expects one of (${t[e].overloadTable})!`), t[e].overloadTable[n.length].apply(this, n)
                   }, t[e].overloadTable = [], t[e].overloadTable[n.argCount] = n
                }
             },
             Ct = (t, e, r) => {
                a.hasOwnProperty(t) ? ((void 0 === r || void 0 !== a[t].overloadTable && void 0 !== a[t].overloadTable[r]) && nt(`Cannot register public name '${t}' twice`), wt(a, t, t), a.hasOwnProperty(r) && nt(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`), a[t].overloadTable[r] = e) : (a[t] = e, void 0 !== r && (a[t].numArguments = r))
             };
          ...
          var bt = (t, e, r) => {
             for (; e !== r;) e.upcast || nt(`Expected null or instance of ${r.name}, got an instance of ${e.name}`), t = e.upcast(t), e = e.baseClass;
             return t
          };
 
          function Ft(t, e) {
             if (null === e) return this.isReference && nt(`null is not a valid ${this.name}`), 0;
             e.$$ || nt(`Cannot pass "${Nt(e)}" as a ${this.name}`), e.$$.ptr || nt(`Cannot pass deleted object as a pointer of type ${this.name}`);
          ...
          function Lt(t, e) {
             var r;
             if (null === e) return this.isReference && nt(`null is not a valid ${this.name}`), this.isSmartPointer ? (r = this.rawConstructor(), null !== t && t.push(this.rawDestructor, r), r) : 0;
             (!e || !e.$$) && nt(`Cannot pass "${Nt(e)}" as a ${this.name}`), e.$$.ptr || nt(`Cannot pass deleted object as a pointer of type ${this.name}`), !this.isConst && e.$$.ptrType.isConst && nt(`Cannot convert argument of type ${e.$$.smartPtrType?e.$$.smartPtrType.name:e.$$.ptrType.name} to parameter type ${this.name}`);
             var n = e.$$.ptrType.registeredClass;
             if (r = bt(e.$$.ptr, n, this.registeredClass), this.isSmartPointer) switch (void 0 === e.$$.smartPtr && nt("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
                case 0:
                ...
                case 2:
                   if (e.$$.smartPtrType === this) r = e.$$.smartPtr;
                      ...
                      var a = e.clone();
                      r = this.rawShare(r, qt.toHandle((() => a.delete()))), null !== t && t.push(this.rawDestructor, r)
                   }
                   break;
                default:
          ...
          function Pt(t, e) {
             if (null === e) return this.isReference && nt(`null is not a valid ${this.name}`), 0;
             e.$$ || nt(`Cannot pass "${Nt(e)}" as a ${this.name}`), e.$$.ptr || nt(`Cannot pass deleted object as a pointer of type ${this.name}`), e.$$.ptrType.isConst && nt(`Cannot convert argument of type ${e.$$.ptrType.name} to parameter type ${this.name}`);
             var r = e.$$.ptrType.registeredClass;
             return bt(e.$$.ptr, r, this.registeredClass)
          }
 
          function Tt(t, e, r, n, a, o, i, s, u, l, c) {
             this.name = t, this.registeredClass = e, this.isReference = r, this.isConst = n, this.isSmartPointer = a, this.pointeeType = o, this.sharingPolicy = i, this.rawGetPointee = s, this.rawConstructor = u, this.rawShare = l, this.rawDestructor = c, a || void 0 !== e.baseClass ? this.toWireType = Lt : n ? (this.toWireType = Ft, this.destructorFunction = null) : (this.toWireType = Pt, this.destructorFunction = null)
          }
          var At, Mt, St = (t, e, r) => {
                a.hasOwnProperty(t) || tt("Replacing nonexistent public symbol"), void 0 !== a[t].overloadTable && void 0 !== r ? a[t].overloadTable[r] = e : (a[t] = e, a[t].argCount = r)
             },
             Et = t => At.get(t),
             kt = (t, e) => {
                var r = (t = rt(t)).includes("j") ? ((t, e) => (...r) => ((t, e, r = []) => t.includes("j") ? ((t, e, r) => (t = t.replace(/p/g, "i"), (0, a["dynCall_" + t])(e, ...r)))(t, e, r) : Et(e)(...r))(t, e, r))(t, e) : Et(e);
                return "function" != typeof r && nt(`unknown function pointer with signature ${t}: ${e}`), r
             },
             jt = t => {
                var e = ge(t),
                   r = rt(e);
          ...
          function It(t, e, r, n, a, o) {
             ...
             return _t(t, (function (...r) {
                var o;
                r.length !== c && nt(`function ${t} called with ${r.length} arguments, expected ${c}`), m.length = 0, h.length = s ? 2 : 1, h[0] = a, s && (o = e[1].toWireType(m, this), h[1] = o);
                for (var i = 0; i < c; ++i) d[i] = e[i + 2].toWireType(m, r[i]), h.push(d[i]);
                return function (t) {
                   if (u) Y(m);
                   else
          ...
          var Rt, Ot = t => {
             ...
             qt = {
                toValue: t => (t || nt("Cannot use deleted val. handle = " + t), Ut[t]),
                toHandle: t => {
                   switch (t) {
                      case void 0:
                         return 2;
             ...
             ee = (t, e, r) => {
                ...
                for (var n = e, a = n + r - 4, o = 0; o < t.length; ++o) {
                   var i = t.charCodeAt(o);
                   if (i >= 55296 && i <= 57343 && (i = 65536 + ((1023 & i) << 10) | 1023 & t.charCodeAt(++o)), g[e >> 2] = i, (e += 4) + 4 > a) break
                }
                return g[e >> 2] = 0, e - n
             },
             re = t => {
          ...
          var oe = t => {
             ...
             le = (t, e) => {
                var r = ue[t];
                0 === e || 10 === e ? ((1 === t ? c : d)(O(r, 0)), r.length = 0) : r.push(e)
             },
             ce = t => (ce = (() => {
          ...
          G = a.InternalError = class extends Error {
             ...
             delete() {
                this.$$.ptr || st(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && nt("Object already scheduled for deletion"), lt(this), ct(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0)
             },
             isDeleted() {
                return !this.$$.ptr
             },
             deleteLater() {
                return this.$$.ptr || st(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && nt("Object already scheduled for deletion"), mt.push(this), 1 === mt.length && ot && ot(pt), this.$$.deleteScheduled = !0, this
             }
          }), a.getInheritedInstanceCount = () => Object.keys(ft).length, a.getLiveInheritedInstances = () => {
             var t = [];
             for (var e in ft) ft.hasOwnProperty(e) && t.push(ft[e]);
             return t
          }, a.flushPendingDeletes = pt, a.setDelayFunction = t => {
             ...
             fromWireType: function (t) {
                ...
                var r = ((t, e) => (e = ((t, e) => {
                   for (void 0 === e && nt("ptr should not be undefined"); t.baseClass;) e = t.upcast(e), t = t.baseClass;
                   return e
                })(t, e), ft[e]))(this.registeredClass, e);
                if (void 0 !== r) {
                ...
                var o, i = this.registeredClass.getActualType(e),
                   s = ht[i];
          ...
          })(Error, "UnboundTypeError"), Ut.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), a.count_emval_handles = () => Ut.length / 2 - 5 - xt.length;
          var pe = {
                c: (t, e, r, n) => {
                ...
                z: (t, e, r, n, a, o, i, s, u, l, c, d, h) => {
                   c = rt(c), o = kt(a, o), s && (s = kt(i, s)), l && (l = kt(u, l)), h = kt(d, h);
                   var m = (t => {
                   ...
                   Ct(m, (function () {
                      ...
                      var r, a, i;
                      e = e[0], i = n ? (a = e.registeredClass).instancePrototype : vt.prototype;
                      var u = _t(c, (function (...t) {
                            if (Object.getPrototypeOf(this) !== d) throw new X("Use 'new' to construct " + c);
                            if (void 0 === p.constructor_body) throw new X(c + " has no accessible constructor");
                            var e = p.constructor_body[t.length];
                            if (void 0 === e) throw new X(`Tried to invoke ctor of ${c} with invalid number of parameters (${t.length}) - expected (${Object.keys(p.constructor_body).toString()}) parameters instead!`);
                      ...
                      p.baseClass && ((r = p.baseClass).__derivedClasses ?? (r.__derivedClasses = []), p.baseClass.__derivedClasses.push(p));
                ...
                x: (t, e, r, n, a, o) => {
                   ...
                   a = kt(n, a), et([], [t], (t => {
                      ...
                      if (void 0 === t.registeredClass.constructor_body && (t.registeredClass.constructor_body = []), void 0 !== t.registeredClass.constructor_body[e - 1]) throw new X(`Cannot register multiple constructors with identical number of parameters (${e-1}) for class '${t.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
                      return t.registeredClass.constructor_body[e - 1] = () => {
                         Dt(`Cannot construct ${t.name} due to unbound types`, i)
                      }, et([], i, (n => (n.splice(1, 0, null), t.registeredClass.constructor_body[e - 1] = It(r, n, null, a, o), []))), []
                   }))
                },
                i: (t, e, r, n, a, o, i, s, u) => {
                   var l = Wt(r, n);
                   e = rt(e), e = Ot(e), o = kt(a, o), et([], [t], (t => {
                      var n = `${(t=t[0]).name}.${e}`;
                      ...
                      var u = t.registeredClass.instancePrototype,
                         c = u[e];
                      return void 0 === c || void 0 === c.overloadTable && c.className !== t.name && c.argCount === r - 2 ? (a.argCount = r - 2, a.className = t.name, u[e] = a) : (wt(u, e, n), u[e].overloadTable[r - 2] = a), et([], l, (a => {
                         var s = It(n, a, t, o, i);
                         return void 0 === u[e].overloadTable ? (s.argCount = r - 2, u[e] = s) : u[e].overloadTable[r - 2] = s, []
                      })), []
                   }))
                },
                da: zt,
                ...
                K: (t, e, r, n, a, o, i) => {
                   var s = Wt(e, r);
                   t = rt(t), t = Ot(t), a = kt(n, a), Ct(t, (function () {
                ...
                ka: (t, e, r, n, a, o, i, s, u, l, c, d) => {
                   r = rt(r), o = kt(a, o), s = kt(i, s), l = kt(u, l), d = kt(c, d), et([t], [e], (t => (t = t[0], [new Tt(r, t.registeredClass, !1, !1, !0, t, n, o, s, l, d)])))
                },
                J: (t, e) => {
                   ...
                   at(t, {
                      ...
                      fromWireType(t) {
                         ...
                         if (r)
                            for (var o = a, i = 0; i <= n; ++i) {
                               ...
                               if (i == n || 0 == p[s]) {
                                  var u = x(o, s - o);
                                  void 0 === e ? e = u : (e += "\0", e += u), o = s + 1
                               }
                            } else {
                               var l = new Array(n);
                               for (i = 0; i < n; ++i) l[i] = String.fromCharCode(p[a + i]);
                               e = l.join("")
                            }
                         return ve(t), e
                      },
                      toWireType(t, e) {
                         ...
                         a || e instanceof Uint8Array || e instanceof Uint8ClampedArray || e instanceof Int8Array || nt("Cannot pass non-string to std::string"), n = r && a ? V(e) : e.length;
                         var o = ye(4 + n + 1),
                            i = o + 4;
                         if (v[o >> 2] = n, r && a)((t, e, r) => {
                            z(t, p, e, r)
                         })(e, i, n + 1);
                         else if (a)
                            for (var s = 0; s < n; ++s) {
                               var u = e.charCodeAt(s);
                               u > 255 && (ve(i), nt("String has UTF-16 code units that do not fit in 8 bits")), p[i + s] = u
                            } else
                               for (s = 0; s < n; ++s) p[i + s] = e[s];
                ...
                y: (t, e, r) => {
                   var n, a, o, i;
                   r = rt(r), 2 === e ? (n = Zt, a = Kt, i = Qt, o = t => y[t >> 1]) : 4 === e && (n = te, a = ee, i = re, o = t => v[t >> 2]), at(t, {
                      name: r,
                      fromWireType: t => {
                      ...
                      toWireType: (t, n) => {
                         ...
                         var o = i(n),
                            s = ye(4 + o + e);
                         return v[s >> 2] = o / e, a(n, s + 4, o + e), null !== t && t.push(ve, s), s
                      },
                      argPackAdvance: 8,
                      readValueFromPointer: N,
                      destructorFunction(t) {
                ...
                ha: (t, e, r) => {
                   var n = ((t, e) => {
                         for (var r = new Array(t), n = 0; n < t; ++n) r[n] = Yt(v[e + 4 * n >> 2], "parameter " + n);
                         return r
                      })(t, e),
                      a = n.shift();
                   t--;
                   ...
                   return (t => {
                      ...
                      for (var l = 0, c = 0; c < t; ++c) o[c] = n[c].readValueFromPointer(u + l), l += n[c].argPackAdvance;
                ...
                Z: (t, e) => {
                   ...
                   return se().forEach(((n, a) => {
                      var o = e + r;
                      v[t + 4 * a >> 2] = o, ((t, e) => {
                         for (var r = 0; r < t.length; ++r) m[e++] = t.charCodeAt(r);
                         m[e] = 0
                      })(n, o), r += n.length + 1
                   })), 0
                },
                ...
                Q: (t, e, r, n, a) => ((t, e, r, n) => {
                      ...
                      var e = ((t, e) => {
                            for (var r = new Date(t.getTime()); e > 0;) {
                               var n = de(r.getFullYear()),
                                  a = r.getMonth(),
                                  o = (n ? he : me)[a];
                               if (!(e > o - r.getDate())) return r.setDate(r.getDate() + e), r;
                   ...
                   for (var u in i = i.replace(/%%/g, "\0\0"), _) i.includes(u) && (i = i.replace(new RegExp(u, "g"), _[u](o)));
             ...
             fe = function () {
                ...
                function e(t, e) {
                   return fe = t.exports, h = fe.la, $(), At = fe.pa,
                      function (t) {
                         F.unshift(t)
                      }(fe.ma),
                      function (t) {
                ...
                if (P++, a.monitorRunDependencies?.(P), a.instantiateWasm) try {
                ...
                return function (t, e, r, n) {
                   return t || "function" != typeof WebAssembly.instantiateStreaming || E(e) || "function" != typeof fetch ? j(e, r, n) : fetch(e, {
                      ...
                      return d(`wasm streaming compile failed: ${t}`), d("falling back to ArrayBuffer instantiation"), j(e, r, n)
                   }))))
                }(l, M, t, (function (t) {
                   e(t.instance)
                })).catch(n), {}
             ...
             Fe = t => (Fe = fe.wa)(t);
          a.dynCall_iijj = (t, e, r, n, o, i) => (a.dynCall_iijj = fe.xa)(t, e, r, n, o, i), a.dynCall_vijj = (t, e, r, n, o, i) => (a.dynCall_vijj = fe.ya)(t, e, r, n, o, i), a.dynCall_jiii = (t, e, r, n) => (a.dynCall_jiii = fe.za)(t, e, r, n), a.dynCall_jii = (t, e, r) => (a.dynCall_jii = fe.Aa)(t, e, r);
          var Le, Pe = a.dynCall_viiij = (t, e, r, n, o, i) => (Pe = a.dynCall_viiij = fe.Ba)(t, e, r, n, o, i);
 
          function Te() {
             function t() {
                Le || (Le = !0, a.calledRun = !0, !C && (D(F), r(a), a.onRuntimeInitialized && a.onRuntimeInitialized(), function () {
                   if (a.postRun)
                      for ("function" == typeof a.postRun && (a.postRun = [a.postRun]); a.postRun.length;) t = a.postRun.shift(), L.unshift(t);
                   var t;
                   D(L)
                }()))
             }
             P > 0 || (function () {
                if (a.preRun)
                   for ("function" == typeof a.preRun && (a.preRun = [a.preRun]); a.preRun.length;) t = a.preRun.shift(), b.unshift(t);
                var t;
                D(b)
             }(), P > 0) || (a.setStatus ? (a.setStatus("Running..."), setTimeout((function () {
                setTimeout((function () {
                   a.setStatus("")
                }), 1), t()
             }), 1)) : t())
          }
          if (a.dynCall_jiji = (t, e, r, n, o) => (a.dynCall_jiji = fe.Ca)(t, e, r, n, o), a.dynCall_viijii = (t, e, r, n, o, i, s) => (a.dynCall_viijii = fe.Da)(t, e, r, n, o, i, s), a.dynCall_iiiiij = (t, e, r, n, o, i, s) => (a.dynCall_iiiiij = fe.Ea)(t, e, r, n, o, i, s), a.dynCall_iiiiijj = (t, e, r, n, o, i, s, u, l) => (a.dynCall_iiiiijj = fe.Fa)(t, e, r, n, o, i, s, u, l), a.dynCall_iiiiiijj = (t, e, r, n, o, i, s, u, l, c) => (a.dynCall_iiiiiijj = fe.Ga)(t, e, r, n, o, i, s, u, l, c), T = function t() {
                Le || Te(), Le || (T = t)
             }, a.preInit)
    ...
    r(c, "_ModulePromise", null), r(c, "_wasmURL", `https://cdn.jsdelivr.net/npm/${s}@${u}/dist/dotlottie-player.wasm`);
    var d = class {
          constructor() {
          ...
          removeEventListener(t, e) {
             let r = this._eventListeners.get(t);
             r && (e ? (r.delete(e), 0 === r.size && this._eventListeners.delete(t)) : this._eventListeners.delete(t))
          }
          dispatch(t) {
       ...
       y = class {
          constructor(t) {
             r(this, "_canvas"), r(this, "_context"), r(this, "_eventManager"), r(this, "_animationFrameId", null), r(this, "_frameManager"), r(this, "_dotLottieCore", null), r(this, "_wasmModule", null), r(this, "_renderConfig", {}), r(this, "_isFrozen", !1), r(this, "_backgroundColor", null), this._canvas = t.canvas, this._context = this._canvas.getContext("2d"), this._eventManager = new d, this._frameManager = new o, this._renderConfig = t.renderConfig ?? {}, c.load().then((e => {
                this._wasmModule = e, this._dotLottieCore = new e.DotLottiePlayer({
          ...
          _loadFromSrc(t) {
             (async function () {
                let e = await fetch(t);
                if (!e.ok) throw new Error(`Failed to fetch the animation data from URL: ${t}. ${e.status}: ${e.statusText}`);
                let r, n = (e.headers.get("content-type") ?? "").trim();
                return r = ["application/json", "text/plain"].some((t => n.startsWith(t))) ? await e.text() : await e.arrayBuffer(), r
             })().then((t => {
          ...
          _loadFromData(t) {
             ...
             let e = this._canvas.width,
                ...
                n = !1;
             if ("string" == typeof t) n = this._dotLottieCore.loadAnimationData(t, e, r);
             else if (t instanceof ArrayBuffer) n = this._dotLottieCore.loadDotLottieData(t, e, r);
             else {
                if ("object" != typeof t) return void this._eventManager.dispatch({
                   type: "loadError",
          ...
          load(t) {
             ...
             }), t.data ? this._loadFromData(t.data) : t.src && this._loadFromSrc(t.src), this.setBackgroundColor(t.backgroundColor ?? ""))
          }
          _render() {
             ...
             if (this._dotLottieCore.render()) {
                let t = this._dotLottieCore.buffer(),
                   ...
                   r = null;
                return typeof ImageData > "u" ? (r = this._context.createImageData(this._canvas.width, this._canvas.height), r.data.set(e)) : r = new ImageData(e, this._canvas.width, this._canvas.height), this._context.putImageData(r, 0, 0), this._eventManager.dispatch({
                   type: "render",
                   currentFrame: this._dotLottieCore.currentFrame()
                }), !0
             }
          ...
          play() {
             ...
             this._isFrozen = !1, t && (this._eventManager.dispatch({
                type: "play"
             }), this._animationFrameId = this._frameManager.requestAnimationFrame(this._draw.bind(this)))
          }
          pause() {
          ...
          setBackgroundColor(t) {
             null !== this._dotLottieCore && (this._canvas instanceof HTMLCanvasElement && (this._canvas.style.backgroundColor = t), this._backgroundColor = t)
          }
          setLoop(t) {
             null !== this._dotLottieCore && this._dotLottieCore.setConfig({
                ...this._dotLottieCore.config(),
    ...
    new y({
       ...
       t.style.setProperty("--body-height", r + "px"), e.addEventListener("click", (e => {
